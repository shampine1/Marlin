...
// This setup is for a cobblebot running Arduino Mega/Ramps
// It is based on Marlin, Development branch
...
#define CUSTOM_MACHINE_NAME "Cobblebot"
...
// :[1,2,3,4]
#define EXTRUDERS 1
// Or if you have 2 extruders, you can put “2”.
// but I suggest getting one working first.
...
// per http://reprap.org/wiki/Hexagon
...
// You will have to find the following out for yourself.
// When you get so your machine can home reliably, then you can use
// host software to move to extents. If your Z motors are more toward
// the center, you will have shorter Y, if your Z lead screws start to
// bind at 275 mm, then make this 270. My philosophy has been to get a
// working printer, even if the build volume is a little reduced, and
// and then you’ll be fighting less uncertainty and fewer variables
// in expanding.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,94.5}  // default steps per unit for Cobblebot
#define DEFAULT_MAX_FEEDRATE          {300, 300, 16, 25}    // (mm/sec)
